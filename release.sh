...
SUBJECT="feat(ui): dynamic site and telemetry versions in footer"

# Semantic bump (forcing patch here since we know it's a minor UI change, or use the node script)
NEW_VERSION=$(node -e '
